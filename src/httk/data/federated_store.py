...
class FederatedResultSet:
    ...
    def one(self) -> ResultRow:
        ...
        :raises httk.data.query.protocols.NoResultError: If no row matches.
        :raises httk.data.query.protocols.MultipleResultsError: If more than one row matches.
        """
...
class FederatedStore:
    ...
    :mod:`httk.data.db.stored_federation`.
...
class FederatedSearcher:
    ...
    def variable(self, target: object) -> FederatedVariable:
        ...
        :raises httk.data.query.protocols.UnsupportedQueryError: If a second root or foreign target is supplied.
    ...
    def add(self, expression: object) -> None:
        ...
        :return: None.
        :raises httk.data.query.protocols.UnsupportedQueryError: If the expression belongs to another searcher.
    ...
    def output(self, value: object, name: str) -> None:
        ...
        :raises httk.data.query.protocols.UnsupportedQueryError: If ``value`` is not owned by this searcher.
    ...
    def add_sort(self, field: object, descending: bool = False) -> None:
        ...
        :raises httk.data.query.protocols.UnsupportedQueryError: Always, because global federation sorting
    ...
    def count(self) -> int:
        ...
        :raises httk.data.query.protocols.CountUnavailableError: If a source cannot provide an exact count.
    ...
    def results(self, **outputs: object) -> FederatedResultSet:
        ...
        :raises httk.data.query.protocols.UnsupportedQueryError: If an output does not belong to this searcher.
