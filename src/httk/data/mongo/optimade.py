...
from httk.data.mongo.searcher import MongoExpression, MongoField, MongoReference, MongoSearcher, MongoVariable
...
def optimade_filter_searcher(
    ...
    *,
    ...
    :raises ~httk.data.query.optimade_filters.FilterTranslationError: If the filter cannot be translated.
