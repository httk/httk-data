...
from httk.data.db.schema import FieldSpec, TableSchema
from httk.data.storage_layout import EntryFamilyLayout
...
# Kept byte-for-byte equivalent to httk.data.db.mapping.entry_dispatch_table_name.
